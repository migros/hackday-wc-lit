 ...
 */
import { type CompiledTemplateResult, type TemplateResult } from 'lit-html';
declare const SERVER_ONLY = 1;
 ...
 */
export declare function html(strings: TemplateStringsArray, ...values: unknown[]): ServerRenderedTemplate;
/**
 ...
 */
export declare const isHydratable: (template: MaybeServerTemplate) => boolean;
